const AboutUs = () => {
    return (
        <div className="relative max-w-7xl mx-auto py-8 md:py-16 lg:py-24 px-4 md:px-8 my-24">
            ...
            <div className="relative z-10 max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 lg:py-20 bg-white text-center">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-cinzel font-semibold mb-3 md:mb-6">Bistro Boss</h2>
                <p className="text-sm sm:text-base text-gray-700 font-inter leading-relaxed max-w-3xl mx-auto">
