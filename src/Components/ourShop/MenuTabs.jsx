...
const MenuTabs = ({category}) => {
    ...
    // const menuTabs = ['salad', 'pizza', 'soups', 'drinks'];
    return (
                ...
                <div className="flex flex-wrap justify-center gap-2 xs:gap-3 sm:gap-4 md:gap-6 lg:gap-8 my-3 sm:my-4 md:my-5">
                    <NavLink 
                        ...
                        className={({ isActive }) => `text-xs sm:text-sm md:text-base lg:text-lg font-medium pb-1 sm:pb-2 px-1 sm:px-2 transition-all duration-200 
                            ${isActive || category === "salad" ? 'text-[#BB8506] border-b-2 sm:border-b-4 border-[#BB8506]' : 'text-black hover:text-[#BB8506]'}`}
                    >
                        SALAD
                    </NavLink>
                    ...
                    <NavLink 
                        to={category ? category : "soup"}
                        className={({ isActive  }) => `text-xs sm:text-sm md:text-base lg:text-lg font-medium pb-1 sm:pb-2 px-1 sm:px-2 transition-all duration-200 
                            ${isActive || category === "soup" ? 'text-[#BB8506] border-b-2 sm:border-b-4 border-[#BB8506]' : 'text-black hover:text-[#BB8506]'}`}
                    >
                        SOUPS
                    </NavLink>
                    <NavLink 
